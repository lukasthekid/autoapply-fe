...
interface CoverLetterPreviewClassicSidebarProps {
  content: string
...
const CoverLetterPreviewClassicSidebar = ({
  content,
  userProfile,
  jobTitle,
  onChange,
}: CoverLetterPreviewClassicSidebarProps) => {
    ...
    <div className="h-full overflow-y-auto bg-gray-100 p-4 md:p-8">
      ...
      <div className="max-w-[210mm] mx-auto bg-white shadow-2xl hover:shadow-3xl transition-shadow min-h-[297mm]">
        ...
        <div className="flex flex-col md:flex-row h-full min-h-[297mm]">
          ...
          {/* Left Sidebar - Light Background with Border */}
          <div className="w-full md:w-1/3 bg-gray-50 border-r-2 border-gray-300 p-8 pt-12 flex flex-col">
            {/* Name */}
            {userName && (
              <div className="mb-6">
            ...
            <div className="space-y-4 flex-1">
              ...
              {userProfile?.phone_number && (
                <div className="text-sm text-gray-700">
                  <div className="font-medium text-gray-500 mb-1">Phone</div>
              ...
              {fullAddress && (
                <div className="text-sm text-gray-700">
                  ...
                  <div className="leading-relaxed">{fullAddress}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full md:w-2/3 p-8 md:p-12 bg-white text-gray-800">
            ...
            <div className="mb-8">
              ...
              <div className="w-20 h-1 bg-gray-400 mt-3"></div>
            </div>
...
export default CoverLetterPreviewClassicSidebar
